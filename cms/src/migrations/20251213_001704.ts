...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "appointments" ADD COLUMN "day" timestamp(3) with time zone DEFAULT '2025-12-13T00:17:03.928Z' NOT NULL;
  ALTER TABLE "payload_locked_documents_rels" ADD COLUMN "third_party_access_id" uuid;
  ALTER TABLE "payload_preferences_rels" ADD COLUMN "third_party_access_id" uuid;
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "businesses_general_next_holiday" ALTER COLUMN "start_date" SET DEFAULT '2025-12-06T05:24:11.625Z';
  ALTER TABLE "businesses_general_next_holiday" ALTER COLUMN "end_date" SET DEFAULT '2025-12-06T05:24:11.626Z';
