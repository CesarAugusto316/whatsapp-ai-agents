...
//     // En Tokyo, 23:59 de la hora local (desconocida) corresponde al 8 de enero porque Tokyo está adelantado.
//     // Pero la hora se mantiene 23:59.
//     expect(result).toBe("Miércoles 8 de enero del 2025, 11:59pm");
//   });
...
//     // Tokyo está en UTC+9, así que 23:59 local corresponde al día siguiente en Tokyo
//     expect(result).toBe("Miércoles 8 de enero del 2025, 11:59pm");
//   });
...
//   test("maneja cambio de mes por zona horaria", () => {
//     const result = formatLocalDateTime(
//       { date: "2025-01-31", time: "23:30:00" },
//       "Pacific/Auckland", // UTC+13 en enero
//     );

//     // Auckland está muy adelantado, así que 23:30 local será del día siguiente
//     expect(result).toBe("Sábado 1 de febrero del 2025, 11:30pm");
//   });

//   test("maneja cambio de año por zona horaria", () => {
//     const result = formatLocalDateTime(
//       { date: "2024-12-31", time: "23:45:00" },
//       "Asia/Tokyo",
//     );

//     expect(result).toBe("Miércoles 1 de enero del 2025, 11:45pm");
//   });
...
//   test("maneja horario de verano", () => {
//     const result = formatLocalDateTime(
//       { date: "2025-03-09", time: "02:30:00" }, // Justo antes del cambio
//       "America/New_York",
//     );

//     expect(result).toBe("Domingo 9 de marzo del 2025, 02:30am");
//   });
