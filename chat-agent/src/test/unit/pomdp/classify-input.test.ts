...
describe("classifyInput", () => {
  ...
  test("should handle Ecuadorian expressions", () => {
    ...
    expect(classifyInput("¿Caben pa' 6?")).toBe(InputIntent.CUSTOMER_QUESTION);
  ...
  test("should handle Central American expressions", () => {
    ...
    expect(classifyInput("¿Cubre pa' 6?")).toBe(InputIntent.CUSTOMER_QUESTION); // "Cubre" como disponibilidad
