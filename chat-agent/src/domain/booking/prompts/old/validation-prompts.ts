...
import { InputType } from "../../input-parser";
...
export const validationPrompts = {
  ...
  intentClassifier() {
    return `
      ...
      1. ${InputType.USER_PROVIDED_DATA} → The message contains ANY explicit reservation information, including:
          - Customer name
      ...
      2. ${InputType.INFORMATION_REQUEST} → The message is purely:
      ...
      - Return ONLY this exact string: "${InputType.USER_PROVIDED_DATA}" OR "${InputType.INFORMATION_REQUEST}"
      - NO explanations, examples, quotes, or additional text.
      - Base classification SOLELY on explicit presence of reservation data.
      - Partial/abbreviated data → ${InputType.USER_PROVIDED_DATA}
      - Question + reservation data → ${InputType.USER_PROVIDED_DATA} (data presence takes priority)
      ...
      OUTPUT: ${InputType.USER_PROVIDED_DATA}
      ...
      OUTPUT: ${InputType.INFORMATION_REQUEST}
      ...
      - Output ONLY: ${InputType.USER_PROVIDED_DATA} or ${InputType.INFORMATION_REQUEST}
      - NO explanations
      - NO additional text
