 ...
 * @param timezone - Timezone del restaurante (ej: "America/Guayaquil") - SOLO para validación futura
...
//   schedule: WeekDay,
//   timezone: string, // Mantenido por compatibilidad, no se usa
//   dateTime: { date: string; time: string },
// ): boolean {
//   try {
//     // 1. Validar y obtener el día de la semana
//     const date = new Date(dateTime.date + "T00:00:00");
//     if (isNaN(date.getTime())) {
//       throw new Error(`Fecha inválida: ${dateTime.date}`);
//     }

//     const dayIndex = date.getDay();
//     const days: (keyof WeekDay)[] = [
//       "sunday",
//       "monday",
//       "tuesday",
//       "wednesday",
...
//     // 2. Verificar si el restaurante está abierto ese día
//     const daySchedule = schedule[weekday];
//     if (!daySchedule || daySchedule.length === 0) {
//       return false;
//     }

//     // 3. Validar y convertir la hora a minutos
...
//     // 4. Verificar si está dentro de algún bloque
...
//     return false; // O lanza el error según tu política
//   }
// }
