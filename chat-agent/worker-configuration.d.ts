/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 5db27eb83274ee29737f0e5fd1ef5237)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		WASENDER_PERSONAL_ACCESS_TOKEN: string;
		CMS_API: Fetcher /* payload-cms */;
		AI: Ai;
		ASSETS: Fetcher;
	}
}
