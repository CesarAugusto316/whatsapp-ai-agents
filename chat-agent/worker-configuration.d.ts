/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: dadc5b9bb6e04bfbd4a9b67a6373031b)
...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    MyAgent: DurableObjectNamespace<
      import("./src/services/ai.service").MyAgent
    > /* MyAgent */;
    VPC_CMS: Fetcher;
    VPC_WHATSAPP: Fetcher;
    AI: Ai;
    ASSETS: Fetcher;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "WAHA_API_KEY" | "WAHA_API">
  > {}
}
