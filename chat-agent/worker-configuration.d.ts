/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: e648037a2a0cb63fdd4835f47b289766)
// Runtime types generated with workerd@1.20251202.0 2025-11-27 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		WASENDER_WEBHOOK_SECRET: "d3db4b24069cad76594e50def5debc51";
		WASENDER_API_KEY: "fbd4f9e89513b2d0481e140cf71e1af79448df97336a890fe95812e5faacbfe1";
		VPC_SERVICE: string;
		WAHA_API_KEY: string;
		VPC_SERVICE: Fetcher;
		AI: Ai;
